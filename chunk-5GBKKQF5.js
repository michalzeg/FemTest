...
`)+`
`+p);let A=I+m+o,E=I+p+a,B=Eh(r,r.VERTEX_SHADER,A),T=Eh(r,r.FRAGMENT_SHADER,E);r.attachShader(x,B),r.attachShader(x,T),t.index0AttributeName!==void 0?r.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(x,0,"position"),r.linkProgram(x);function R(L){if(i.debug.checkShaderErrors){let Y=r.getProgramInfoLog(x).trim(),G=r.getShaderInfoLog(B).trim(),J=r.getShaderInfoLog(T).trim(),ne=!0,K=!0;if(r.getProgramParameter(x,r.LINK_STATUS)===!1)if(ne=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,x,B,T);else{let ae=wh(r,B,"vertex"),q=wh(r,T,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(x,r.VALIDATE_STATUS)+`
